  ...
  return (
    <div className='flex flex-col items-start max-w-xl mx-auto my-16'>
        ...
        <div className='flex p-4 mt-5 border-none bg-secondary'>
            ...
            <div>
                We have generated chapters for each of your units. Confirm whether these chapters are suitable and click the button to start generating course content. NOTE: This may take a while!
            </div>
        </div>
